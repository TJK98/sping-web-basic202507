...
//    private final FeedRepository feedRepository; // 이제 레파지토리와의 의존 관계는 다 제거가 됐다.
...
//    }
    ...
    // 피드 등록 요청
    @PostMapping
    public ResponseEntity<?> createdFeed(@RequestBody FeedCreateRequest dto) {
